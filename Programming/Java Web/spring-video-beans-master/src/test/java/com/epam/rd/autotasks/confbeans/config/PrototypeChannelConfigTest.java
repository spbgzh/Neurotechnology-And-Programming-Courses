...
@SpringJUnitConfig(PrototypeChannelConfig.class)
class PrototypeChannelConfigTest {
    ...
    void testVideo1() {
        ...
        assertSame(video1, videoBeans.get("video1"));
    }
    ...
    void testChannel() {
        ...
        assertTrue(channel.videos().anyMatch(v -> video1 == v));
